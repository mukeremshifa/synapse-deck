...
| DS4b — The surface pass | [DS4b-surface-pass.md](DS4b-surface-pass.md) | 📋 **Planned 2026-09-07, next to execute.** DS4's tasks 2–6, unchanged in substance. **Blocked until an account can be signed into** — the plan opens with the one command that unblocks it |
